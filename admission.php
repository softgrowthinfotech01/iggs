        ...
        <div class="bg-white rounded-[40px] p-8 lg:p-10 shadow-[0_35px_90px_rgba(15,23,42,0.12)] border border-blue-100">
            ...
            <form class="mt-10 space-y-5">
                ...
                <div class="grid md:grid-cols-2 gap-5">
                    <input type="text" placeholder="Student Name" class="h-14 rounded-2xl border border-slate-200 px-5 outline-none focus:border-blue-700">
                    <input type="text" placeholder="Parent Name" class="h-14 rounded-2xl border border-slate-200 px-5 outline-none focus:border-blue-700">
                </div>

                <div class="grid md:grid-cols-2 gap-5">
                    <input type="tel" placeholder="Mobile Number" class="h-14 rounded-2xl border border-slate-200 px-5 outline-none focus:border-blue-700">
                    <select class="h-14 rounded-2xl border border-slate-200 px-5 outline-none focus:border-blue-700">
                ...
                <textarea rows="6" placeholder="Message" class="w-full rounded-2xl border border-slate-200 p-5 outline-none focus:border-blue-700 resize-none"></textarea>

                <button type="submit" class="w-full h-16 rounded-2xl bg-slate-950 text-white font-black hover:bg-blue-700 hover:-translate-y-2 transition duration-500">
                    Submit Enquiry
                </button>
