                        ...
                        <div class="flex items-center gap-5">
                            ...
                            <div>
                                ...
                                <p class="mt-2 text-cyan-100 font-semibold">
                                    Secured 98% In Final Examination
                                </p>
                            </div>
        ...
        <div class="mt-16 grid md:grid-cols-2 xl:grid-cols-3 gap-8">
            ...
            <div class="group rounded-[35px] overflow-hidden bg-white border border-blue-100 shadow-[0_30px_80px_rgba(15,23,42,0.10)] hover:-translate-y-4 transition duration-500">
                ...
                <div class="relative h-[340px] overflow-hidden">
                    ...
                    <img src="images/student1.jpg" alt="Student" class="w-full h-full object-cover group-hover:scale-110 transition duration-700">
                    ...
                    <div class="absolute bottom-5 left-5 right-5">
                        ...
                        <p class="mt-2 text-blue-100 font-semibold">School Topper</p>
                    </div>
                ...
                <div class="p-7">
                    ...
                    <div class="flex items-center justify-between pt-5">
                        <span class="font-bold text-slate-500">Result Status</span>
            ...
            <div class="group rounded-[35px] overflow-hidden bg-white border border-cyan-100 shadow-[0_30px_80px_rgba(15,23,42,0.10)] hover:-translate-y-4 transition duration-500">

                <div class="relative h-[340px] overflow-hidden">

                    <img src="images/student2.jpg" alt="Student" class="w-full h-full object-cover group-hover:scale-110 transition duration-700">

                    <div class="absolute inset-0 bg-gradient-to-t from-slate-950/90 via-slate-900/20 to-transparent"></div>

                    <div class="absolute top-5 left-5">
                        <span class="px-5 py-2 rounded-full bg-cyan-600 text-white font-black text-sm shadow-xl">
                            97%
                        </span>
                    </div>

                    <div class="absolute bottom-5 left-5 right-5">
                        <h3 class="text-3xl font-black text-white">Sakshi Thakur</h3>
                        <p class="mt-2 text-cyan-100 font-semibold">Academic Excellence</p>
                    </div>
            ...
            <div class="group rounded-[35px] overflow-hidden bg-white border border-orange-100 shadow-[0_30px_80px_rgba(15,23,42,0.10)] hover:-translate-y-4 transition duration-500">

                <div class="relative h-[340px] overflow-hidden">

                    <img src="images/student3.jpg" alt="Student" class="w-full h-full object-cover group-hover:scale-110 transition duration-700">

                    <div class="absolute inset-0 bg-gradient-to-t from-slate-950/90 via-slate-900/20 to-transparent"></div>

                    <div class="absolute top-5 left-5">
                        <span class="px-5 py-2 rounded-full bg-orange-500 text-white font-black text-sm shadow-xl">
                            96%
                        </span>
                    </div>

                    <div class="absolute bottom-5 left-5 right-5">
                        <h3 class="text-3xl font-black text-white">Kunal Deshmukh</h3>
                        <p class="mt-2 text-orange-100 font-semibold">Merit Student</p>
                    </div>
