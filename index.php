        ...
        <div class="grid lg:grid-cols-2 gap-20 items-center">
            ...
            <div class="relative">
                ...
                <div class="relative bg-white rounded-[45px] shadow-[0_35px_90px_rgba(15,23,42,0.10)] border border-white overflow-hidden">
                    ...
                    <div class="relative md:h-[650px] overflow-hidden">
                        <img src="images/IG_ABOUT.png" class="h-full" alt="">
            ...
            <div>
                ...
                <p class="mt-8 text-black leading-9 text-lg  text-justify">
                    ...
                    discipline, innovation and leadership development.
                ...
                <p class="mt-6 text-black leading-9 text-justify text-lg">
                    ...
                    become confident future-ready individuals.
        ...
        <div class="grid lg:grid-cols-[0.9fr_1.1fr] gap-16 items-center">
            ...
            <div>
                ...
                <div class="relative mt-10 bg-white rounded-[40px] p-8 shadow-[0_30px_80px_rgba(15,23,42,0.10)] border border-slate-100 overflow-hidden">
                    ...
                    <p class="mt-5 text-2xl leading-10 font-bold text-slate-800">
                        “We don’t only teach lessons, we build character, confidence and future-ready students.”
                    </p>
